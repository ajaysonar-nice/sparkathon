...
/* harmony default export */ __webpack_exports__["default"] = ("<div>\n\n  <h1 style=\"text-align: center;margin-top: 2% !important;\">{{name}}</h1>\n  <!-- <mat-card *ngIf=\"recognizing\" class=\"notification\">{{notification}}</mat-card> -->\n  \n    <button style=\"width: 100px; height: 50px; margin-left: 6%\"  type=\"button\" mat-raised-button color=\"primary\" (click)=\"startButton($event)\">\n      <mat-icon *ngIf=\"!recognizing\" class=\"mat-icon\">mic</mat-icon>\n      <mat-icon *ngIf=\"recognizing\" class=\"mat-icon\">stop</mat-icon>\n    </button>\n\n  <div style=\"width:90% !important;margin-right:5% !important;margin-left:5% !important;\">\n  \n    <textarea disabled style=\"width: 98%; min-height: 150px; max-height: 150px;margin: 1%;font-size: medium;font-family: cursive;overflow-y: scroll;font-style: italic;\" [value]=\"innerHtml\" id=\"speechdiv\"></textarea>\n  \n  </div>\n\n  <div style=\"width:90%;margin-left: 5%;margin-top: 1%;\">\n    <canvas style=\"height:300px !important;\" id=\"mycanvas\"></canvas>\n  </div>\n</div>");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(_httpClient) {
        this.count = 6;
        this.minutes = 0;
        this.name = 'Real Time Behavioural Guidance';
        ...
        this.getLabel = function () {
            ...
            return (this.minutes == 0 ? "" : this.minutes + ":") + this.count;
        };
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.myChart = new chart_js__WEBPACK_IMPORTED_MODULE_3__["Chart"](canvas, {
            type: 'line',
            data: {
    ...
    AppComponent.prototype.startButton = function (event) {
        var _this = this;
        if (this.recognizing) {
            this.stop();
        }
        else {
            this.timer = setInterval(function () { _this.count++; }, 1000);
            this.recognizing = true;
            console.log("record");
            var audioConfig = microsoft_cognitiveservices_speech_sdk__WEBPACK_IMPORTED_MODULE_4__["AudioConfig"].fromDefaultMicrophoneInput();
            var speechConfig = microsoft_cognitiveservices_speech_sdk__WEBPACK_IMPORTED_MODULE_4__["SpeechConfig"].fromSubscription("bdedbe3e20744f05809cd3169a30f075", "eastus");
            speechConfig.speechRecognitionLanguage = 'en-US';
            speechConfig.enableDictation();
            this._recognizer = new microsoft_cognitiveservices_speech_sdk__WEBPACK_IMPORTED_MODULE_4__["SpeechRecognizer"](speechConfig, audioConfig);
    ...
    AppComponent.prototype.recognizerCallback = function (s, e) {
        console.log(e.result.text);
        var reason = microsoft_cognitiveservices_speech_sdk__WEBPACK_IMPORTED_MODULE_4__["ResultReason"][e.result.reason];
        console.log(reason);
    ...
    AppComponent.prototype.getAnalysis = function (text) {
        ...
        this.httpClient.post("https://localhost:5001/WeatherForecast", { "text": text }, { headers: headers })
            ...
            _this.myChart.data.datasets[0].data.push(Math.floor(res.sentiment));
            _this.myChart.data.datasets[1].data.push(_this.getRandomIntInclusive(1, 100));
            _this.myChart.data.datasets[2].data.push(_this.getRandomIntInclusive(1, 100));
            _this.myChart.update();
        });
    };
    AppComponent.prototype.stop = function () {
        this._recognizer.stopContinuousRecognitionAsync(stopRecognizer.bind(this), function (err) {
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatCardModule"], _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatIconModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"]],
...
module.exports = __webpack_require__(/*! C:\EXPT\Angular\SpeechToText-master\src\main.ts */"./src/main.ts");
